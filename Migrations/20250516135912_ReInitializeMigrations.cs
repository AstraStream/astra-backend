        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotpTwoFactorEnabled = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalReedemed = table.Column<int>(type: "integer", maxLength: 10, nullable: false),
                    LastEarnedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rewards", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Wallets", x => new { x.UserId, x.ChainId });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Wallets_Chains_ChainId",
                        column: x => x.ChainId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wallets_ChainId",
                table: "Wallets",
                column: "ChainId");

            migrationBuilder.CreateIndex(
                name: "IX_Wallets_UserId_ChainId",
                table: "Wallets",
                columns: new[] { "UserId", "ChainId" },
                unique: true);
        }
